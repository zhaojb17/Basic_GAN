...
# This file is used for generating adversarial networks for MNIST.
# ***************************************************************
...
parser.add_argument('--save_dir', type=str, default='./images/MNIST/', help="data dir")
parser.add_argument('--log_dir', type=str, default='MNIST_log.txt', help="log dir")
...
def main():
    ...
    train_dataset = datasets.MNIST(root=args.data_dir, train=True, download=True, transform=tranformations)
    test_dataset = datasets.MNIST(root=args.data_dir, train=False, download=True, transform=tranformations)
